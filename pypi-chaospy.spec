...
Version  : 4.3.10
Release  : 21
URL      : https://files.pythonhosted.org/packages/53/1a/2afb10b9ad97588201a75a88bdf4dd52dae0f17fb69ea27eb930555e15d3/chaospy-4.3.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/53/1a/2afb10b9ad97588201a75a88bdf4dd52dae0f17fb69ea27eb930555e15d3/chaospy-4.3.10.tar.gz
...
%prep
%setup -q -n chaospy-4.3.10
cd %{_builddir}/chaospy-4.3.10
pushd ..
cp -a chaospy-4.3.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673539772
