...
Source0  : https://files.pythonhosted.org/packages/3b/77/f5ed6b81eefc48312fe726c4aaec868345aa13306f4539e1db670330175f/chaospy-4.3.16.tar.gz
...
%prep
%setup -q -n chaospy-4.3.16
cd %{_builddir}/chaospy-4.3.16
pushd ..
cp -a chaospy-4.3.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721243186
