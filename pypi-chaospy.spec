...
Source0  : https://files.pythonhosted.org/packages/c3/72/12c5d2adb11626c75dc24f1966599b9fa65d0ffa6667160b0cd4a5c2b962/chaospy-4.3.15.tar.gz
...
%prep
%setup -q -n chaospy-4.3.15
cd %{_builddir}/chaospy-4.3.15
pushd ..
cp -a chaospy-4.3.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716089462
